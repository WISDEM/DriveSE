...
class Drive3pt(Assembly):
    ...
    Optimiser = Str( iotype='in',desc='CONMINdriver/COBYLAdriver/SLSQPdriver/Genetic/NEWSUMTdriver')
    Objective_function = Str( iotype='in',desc='Mass/Costs/Efficiency/Aspect ratio')
    ...
    def configure(self):
        ...
        # workflow
        self.driver.workflow.add(['above_yaw_massAdder', 'nacelleSystem', 'lowSpeedShaft', 'mainBearing', 'secondBearing', 'gearbox', 'highSpeedSide', 'transformer','generator', 'bedplate', 'yawSystem','rna','comp'])
        ...
        #self.connect('drivetrain_design','comp.drivetrain_design')
        ...
        self.connect('Objective_function','comp.Objective_function')
        self.connect('Target_Efficiency','comp.Target_Efficiency')
        self.connect('comp.Efficiency','ActualDrivetrainEfficiency')
        self.connect('Optimiser','comp.Optimiser')
        self.connect('Gearbox_output','comp.Generator_input')
        ...
        self.connect('Gearbox_efficiency', 'comp.Gearbox_efficiency')
        ...
        #self.connect('lowSpeedShaft.design_torque', ['mainBearing.lss_design_torque', 'secondBearing.lss_design_torque','comp.design_torque'])
        ...
        #self.connect('lowSpeedShaft.length', ['comp.lowSpeedShaft_length','bedplate.lss_length'])
        ...
        self.connect('comp.mass', ['bedplate.generator_mass','above_yaw_massAdder.generator_mass', 'nacelleSystem.generator_mass', 'generator_mass'])
        ...
        #self.connect('lowSpeedShaft.cm', ['nacelleSystem.lss_cm','comp.lowSpeedShaft_cm'])
        ...
        self.connect('highSpeedSide.cm', ['nacelleSystem.hss_cm','comp.highSpeedSide_cm'])
        self.connect('highSpeedSide.length', 'comp.highSpeedSide_length')
        self.connect('comp.cm', ['nacelleSystem.generator_cm'])
        #self.connect('comp.cm[0]','bedplate.generator_location')
        ...
        self.connect('comp.I', ['nacelleSystem.generator_I'])
        ...
        self.connect('comp.cm', 'transformer.generator_cm')
        ...
        self.connect('comp.mass', 'rna.generator_mass')
        ...
        self.connect('comp.cm', 'rna.generator_cm')
        ...
        #self.connect('generator.drivetrain_design','comp.drivetrain_design')
...
class Drive4pt(Assembly):
    ...
    def configure(self):
        ...
        # workflow
        self.driver.workflow.add(['above_yaw_massAdder', 'nacelleSystem', 'lowSpeedShaft', 'mainBearing', 'secondBearing', 'gearbox', 'highSpeedSide', 'generator', 'bedplate', 'yawSystem','transformer','rna','comp'])
        ...
        self.connect('highSpeedSide.cm', ['nacelleSystem.hss_cm','comp.highSpeedSide_cm','generator.highSpeedSide_cm'])
        self.connect('highSpeedSide.length',['comp.highSpeedSide_length', 'generator.highSpeedSide_length'])
...
def sys_print(nace):
    ...
    print 'Generator mass properties: %8.1f kg %6.2f Ixx(kg-m^2) %6.2f Iyy(kg-m^2) %6.2f Izz(kg-m^2) %6.2f CGx %6.2f CGy %6.2f CGz' \
          % (nace.comp.mass, nace.comp.I[0], nace.comp.I[1], nace.comp.I[2], nace.comp.cm[0], nace.comp.cm[1], nace.comp.cm[2])
    print 'Optimised generator dimensions: R_s:%8.1f m  L:%6.2f m h_s:%6.2f mm h_r:%6.2f mm I_0:%6.2f A  B_symax:%6.2f T' \
          % (nace.comp.DFIG_r_s,nace.comp.DFIG_l_s,nace.comp.DFIG_h_s*1000,nace.comp.DFIG_h_r*1000,nace.comp.DFIG_I_0,nace.comp.DFIG_B_symax)  
