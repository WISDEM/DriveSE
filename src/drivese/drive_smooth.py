...
class Drive3ptSmooth(Assembly):
    ...
    def configure(self):
        ...
        self.add('highSpeedSide', HighSpeedSideSmooth())
        ...
        self.add('rna', RNASystemAdderSmooth())

        # workflow
        self.driver.workflow.add(['above_yaw_massAdder', 'nacelleSystem', 'lowSpeedShaft', 'gearbox', 'highSpeedSide', 'transformer','generator', 'bedplate', 'yawSystem','rna'])

        # connect inputs
        self.connect('rotor_diameter', ['lowSpeedShaft.rotor_diameter', 'gearbox.rotor_diameter', 'highSpeedSide.rotor_diameter', \
        ...
        self.connect('lowSpeedShaft.main_bearing_.cm[0]', 'bedplate.mb1_location')
        ...
        self.connect('lowSpeedShaft.main_bearing_mass', ['bedplate.mb1_mass','above_yaw_massAdder.main_bearing_mass', 'nacelleSystem.main_bearing_mass', 'main_bearing_mass'])
        self.connect('0.0', ['bedplate.mb2_mass','above_yaw_massAdder.second_bearing_mass', 'nacelleSystem.second_bearing_mass', 'second_bearing_mass'])
        ...
        self.connect('lowSpeedShaft.second_bearing_cm', 'nacelleSystem.main_bearing_cm')
        self.connect('lowSpeedShaft.second_bearing_cm', 'nacelleSystem.second_bearing_cm')
        ...
        self.connect('lowSpeedShaft.main_bearing_I', 'nacelleSystem.main_bearing_I')
        self.connect('lowSpeedShaft.second_bearing_I', 'nacelleSystem.second_bearing_I')
        ...
        self.connect('lowSpeedShaft.main_bearing_mass', 'rna.main_bearing_mass')
        ...
        self.connect('lowSpeedShaft.main_bearing_cm', 'rna.main_bearing_cm')
        ...
        self.connect('lowSpeedShaft.main_bearing_cm','MB1_location')
...
class Drive4pt(Assembly):
    ...
    def configure(self):
        ...
        # workflow
        self.driver.workflow.add(['above_yaw_massAdder', 'nacelleSystem', 'lowSpeedShaft', 'gearbox', 'highSpeedSide', 'generator', 'bedplate', 'yawSystem','transformer','rna'])
        ...
        self.connect('lowSpeedShaft.mass', ['bedplate.lss_mass','above_yaw_massAdder.lss_mass', 'nacelleSystem.lss_mass', 'low_speed_shaft_mass'])
        self.connect('lowSpeedShaft.main_bearing_mass', ['bedplate.mb1_mass','above_yaw_massAdder.main_bearing_mass', 'nacelleSystem.main_bearing_mass', 'main_bearing_mass'])
        self.connect('lowSpeedShaft.second_bearing_mass', ['bedplate.mb2_mass','above_yaw_massAdder.second_bearing_mass', 'nacelleSystem.second_bearing_mass', 'second_bearing_mass'])
        self.connect('gearbox.mass', ['lowSpeedShaft.gearbox_mass', 'above_yaw_massAdder.gearbox_mass', 'nacelleSystem.gearbox_mass', 'gearbox_mass'])
        self.connect('highSpeedSide.mass', ['bedplate.hss_mass','above_yaw_massAdder.hss_mass', 'nacelleSystem.hss_mass', 'high_speed_side_mass'])
        self.connect('generator.mass', ['bedplate.generator_mass','above_yaw_massAdder.generator_mass', 'nacelleSystem.generator_mass', 'generator_mass'])
        self.connect('bedplate.mass', ['above_yaw_massAdder.bedplate_mass', 'nacelleSystem.bedplate_mass', 'bedplate_mass'])
        ...
        self.connect('lowSpeedShaft.main_bearing_cm', 'nacelleSystem.main_bearing_cm')
        self.connect('lowSpeedShaft.main_bearing_cm[0]', 'bedplate.mb1_location')
        self.connect('lowSpeedShaft.second_bearing_cm', 'nacelleSystem.second_bearing_cm')
        self.connect('lowSpeedShaft.second_bearing_cm[0]', 'bedplate.mb2_location')
        ...
        self.connect('generator.cm', 'transformer.generator_cm')
        self.connect('lowSpeedShaft.mass', 'rna.lss_mass')
        self.connect('lowSpeedShaft.mb1mass', 'rna.main_bearing_mass')
        self.connect('lowSpeedShaft.mb2mass', 'rna.second_bearing_mass')
        self.connect('gearbox.mass', 'rna.gearbox_mass')
        self.connect('highSpeedSide.mass', 'rna.hss_mass')
        self.connect('generator.mass', 'rna.generator_mass')
        self.connect('overhang', 'rna.overhang')
        ...
        self.connect('lowSpeedShaft.cm', 'rna.lss_cm')
        self.connect('lowSpeedShaft.main_bearing_cm', 'rna.main_bearing_cm')
        self.connect('lowSpeedShaft.second_bearing_cm', 'rna.second_bearing_cm')
        self.connect('gearbox.cm', 'rna.gearbox_cm')
        self.connect('highSpeedSide.cm', 'rna.hss_cm')
        self.connect('generator.cm', 'rna.generator_cm')
        self.connect('machine_rating', 'rna.machine_rating')
        ...
        self.connect('lowSpeedShaft.main_bearing_mass', 'main_bearing_mass')
        self.connect('lowSpeedShaft.second_bearing_mass', 'second_bearing_mass')
